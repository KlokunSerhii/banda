...
const formSchema = {
  ...
  sex: string().oneOf(['male', 'female']).required('Sex input is rquired!'),
              ...
              <div className={styles.formContainer}>
                ...
                <div className={styles.formContainer}>
                  ...
                  <div className={styles.secondStepActivities}>
                    ...
                    <label
                      className={`${styles.activitiesLabel} ${styles.secondStepLabel}`}
                    >
                      <input
                        className={styles.radio}
                        type="radio"
              ...
              <div className={styles.formContainer}>
                <div className={styles.descriptionWrapper}>
                  ...
                  <p className={styles.description}>
                    ...
                    lifestyle. The collected information will allow us to
                    provide you with a more individual and personalized
                    approach.
                  </p>
                </div>
                <div className={styles.submitPageNav}>
                  <button type="submit" className={styles.goToBtn}>
                    <NavLink to="/diary">Go</NavLink>
                  </button>
                  <button
                    type="button"
                    className={`${styles.backBtn}  ${styles.btn}`}
